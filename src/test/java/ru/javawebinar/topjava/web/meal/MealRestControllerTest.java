...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void createInvalid() throws Exception {
        Meal invalid = new Meal(null, null, "Invalid", 1000);
    ...
    void createDuplicateDateTime() throws Exception {
        Meal invalid = new Meal(null, meal1.getDateTime(), "Invalid", 1000);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(invalid))
                .with(userHttpBasic(user)))
                ...
                .andExpect(errorType(ErrorType.VALIDATION_ERROR))
                .andExpect(detailsMessage(ExceptionInfoHandler.EXCEPTION_DUPLICATE_DATETIME));
    }
    ...
    void updateDuplicateDateTime() throws Exception {
        Meal invalid = new Meal(MEAL1_ID, meal2.getDateTime(), "test", 1000);
        perform(MockMvcRequestBuilders.put(REST_URL + MEAL1_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(invalid))
                .with(userHttpBasic(user)))
